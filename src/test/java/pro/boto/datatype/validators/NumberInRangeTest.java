...
public class NumberInRangeTest {
    ...
    public void testIsInByteRange() {
        ...
        assertTrue(NumberInRange.isInByteRange(Byte.MIN_VALUE));
        assertTrue(NumberInRange.isInByteRange(Byte.MAX_VALUE));
        ...
        assertTrue(NumberInRange.isInByteRange(126.56));
        assertTrue(NumberInRange.isInByteRange(127.01));
        assertTrue(NumberInRange.isInByteRange(127.46));

        assertTrue(NumberInRange.isInByteRange(127.49));
        assertFalse(NumberInRange.isInByteRange(127.50));
        assertFalse(NumberInRange.isInByteRange(127.51));
    ...
    public void testIsInShortRange() {
        ...
        assertFalse(NumberInRange.isInShortRange(32767.55));
    ...
    public void testIsInIntegerRange() {
        ...
        assertTrue(NumberInRange.isInIntegerRange((double)Integer.MAX_VALUE+0.45));
        assertFalse(NumberInRange.isInIntegerRange((double)Integer.MAX_VALUE+0.55));
    ...
    public void testIsInLongRange() {
        ...
        assertFalse(NumberInRange.isInLongRange(BigDecimal.valueOf(Long.MAX_VALUE).add(BigDecimal.valueOf(0.55))));
